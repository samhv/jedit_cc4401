...
AppCopyright=Copyright © 1998-2015 Contributors
AppID=jEdit
AppName=jEdit
...
VersionInfoCopyright=Copyright © 1998-2015 Contributors
...
Source: jars\PMDPlugin.jar; DestDir: {app}\jars; Flags: ignoreversion sortfilesbyextension sortfilesbyname; Components: main
